...
<qgis simplifyMaxScale="1" simplifyAlgorithm="0" version="3.0.0-Girona" minScale="1e+8" simplifyDrawingHints="1" readOnly="0" simplifyDrawingTol="1" hasScaleBasedVisibilityFlag="0" labelsEnabled="0" simplifyLocal="1" maxScale="0">
  ...
  <aliases>
    ...
    <alias index="1" name="" field="geogig.changeType"/>
    <alias index="2" name="" field="new_NAME"/>
  </aliases>
  ...
  <defaults>
    ...
    <default expression="" applyOnUpdate="0" field="new_NAME"/>
  </defaults>
  <constraints>
    ...
    <constraint unique_strength="0" notnull_strength="0" constraints="0" field="new_NAME" exp_strength="0"/>
  </constraints>
  <constraintExpressions>
    <constraint desc="" exp="" field="id"/>
    <constraint desc="" exp="" field="geogig.changeType"/>
    <constraint desc="" exp="" field="new_NAME"/>
  </constraintExpressions>
  <attributeactions>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortOrder="0" sortExpression="">
    <columns>
      ...
      <column hidden="0" width="-1" name="new_NAME" type="field"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <editable>
    ...
    <field editable="1" name="new_NAME"/>
  </editable>
  <labelOnTop>
    <field labelOnTop="0" name="geogig.changeType"/>
    <field labelOnTop="0" name="id"/>
    <field labelOnTop="0" name="new_NAME"/>
  </labelOnTop>
  <widgets/>
  <conditionalstyles>
    <rowstyles/>
